        ...
        <section className="theme-padding">
            <Container className={styles.portfolioWrapper}>
                <Row className="justify-content-center text-center">
                    <Col lg={6}>
                        <Title value="Our Projects" span="Some of" subTitle="Our Creative Works For Clients" />
                    </Col>
                </Row>
                <Row>
                    <Col>
                        <Tabs defaultActiveKey="all" id="uncontrolled-tab-example" className="mb-3">
                            ...
                            <Tab eventKey="profile" title="Web Applications">
                                <Row>
                                    {portfolioData.slice(1, 2).map((value, index) => {
                                        return (
                                            <Col lg={4} key={index}>
                                                <Card className={styles.portfolioCard}>
                                                    <Link href="/">
                            ...
                            <Tab eventKey="contact" title="Mobile Applications">
                                <Row>
                                    {portfolioData.slice(0, 2).map((value, index) => {
                                        return (
                                            <Col lg={4} key={index}>
                                                <Card className={styles.portfolioCard}>
                                                    <div className={styles.portfolioThumb}>
