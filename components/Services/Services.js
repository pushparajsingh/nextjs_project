                                                    ...
                                                    <Link href="#">
                                                        <a>
                                                            <Image 
                                                                ...
                                                                alt="service-icon"
                                                            />
                                                            <h4 className={styles.serviceTitle}>{value.service}</h4>
                                                        </a>
                                                    </Link>
                                                </li>
                                            )
