        ...
        <section className={`${styles.careerPage} theme-padding`}>
            <Container>
                <Row className="align-items-center">
                    ...
                    <Col md={6}>
                        <Image src={careerGraphic} className="img-fluid" alt="career-image" />
                    </Col>
                </Row>
                <Row>
                    {series.map(() => {
